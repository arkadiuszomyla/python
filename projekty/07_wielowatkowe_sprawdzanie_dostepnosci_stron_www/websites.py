...
class Websites:
    def __init__(self, filename):
        ...
        self.reportList = [] # lista do wrzucenia wyników
        self.index = 0
    ...
    def loadFile(self, filename):
        ...
        for v in dataList:
            v = "https://" + v.strip()  #czyścimy białe znaki
            data = {"website: ": v, "statusCode ": -1}
            self.fileList.append(data)
            data["index"] = len(self.fileList) - 1  #ustawiamy index w naszym słowniku
            #print(data)
    ...
    def saveReport(self):
        ...
        for el in self.reportList:
            fh.write(str(el["website"]) + " - " + str(el)) #do danej strony przypisz cały wiersz ze słownika