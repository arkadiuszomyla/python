...
def CreateFunctionWithWrapper_LogToFile(logFilePath):
    def CreateFunctionWitchWrapper(func):
       def func_with_wrapper(*args, **kwargs):
          ...
          file.write("\n")
          file.write(" ".join("{}={}".format(k,v) for (k,v) in kwargs.items()))   #kwarg to klucz i wartosc, dlatego dwie zmienne
          file.write("\n")
...
@CreateFunctionWithWrapper_LogToFile(r'c:\temp\change_salary_log.txt')  # dekorowanie funkcji, będzie uruchamiana z wrapperem powyżej
...
@CreateFunctionWithWrapper_LogToFile(r'c:\temp\change_position_log.txt')  # dekorowanie funkcji, będzie uruchamiana z wrapperem powyżej
